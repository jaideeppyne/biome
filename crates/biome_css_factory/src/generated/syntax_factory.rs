    ...
    fn make_syntax(
        ...
        match kind {
            ...
            CSS_CLASS_SELECTOR => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyCssSelectorCustomIdentifier::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
            ...
            CSS_CONTAINER_SCROLL_STATE_AND_QUERY => {
                ...
                let mut current_element = elements.next();
                if let Some(element) = &current_element
                    && CssContainerScrollStateInParens::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyCssContainerScrollStateAndCombinableQuery::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_CONTAINER_SCROLL_STATE_AND_QUERY.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_CONTAINER_SCROLL_STATE_AND_QUERY, children)
            }
            CSS_CONTAINER_SCROLL_STATE_IN_PARENS => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyCssContainerScrollStateInParens::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_CONTAINER_SCROLL_STATE_IN_PARENS.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_CONTAINER_SCROLL_STATE_IN_PARENS, children)
            }
            CSS_CONTAINER_SCROLL_STATE_NOT_QUERY => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_CONTAINER_SCROLL_STATE_NOT_QUERY.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_CONTAINER_SCROLL_STATE_NOT_QUERY, children)
            }
            CSS_CONTAINER_SCROLL_STATE_OR_QUERY => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyCssContainerScrollStateOrCombinableQuery::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_CONTAINER_SCROLL_STATE_OR_QUERY.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_CONTAINER_SCROLL_STATE_OR_QUERY, children)
            }
            CSS_CONTAINER_SCROLL_STATE_QUERY_IN_PARENS => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyCssContainerScrollStateQuery::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_CONTAINER_SCROLL_STATE_QUERY_IN_PARENS.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_CONTAINER_SCROLL_STATE_QUERY_IN_PARENS, children)
            }
            ...
            CSS_IF_SASS_TEST => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_IF_SASS_TEST.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_IF_SASS_TEST, children)
            }
            CSS_IF_STYLE_TEST => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<4usize> = RawNodeSlots::default();
            ...
            CSS_KEYFRAMES_RANGE_SELECTOR => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_KEYFRAMES_RANGE_SELECTOR.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_KEYFRAMES_RANGE_SELECTOR, children)
            }
            ...
            CSS_QUERY_FEATURE_BOOLEAN => {
                ...
                let mut current_element = elements.next();
                if let Some(element) = &current_element
                    && AnyCssQueryFeatureName::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
            ...
            CSS_VALUE_ROOT => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        CSS_VALUE_ROOT.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(CSS_VALUE_ROOT, children)
            }
            ...
            SCSS_AT_ROOT_AT_RULE => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssAtRootQuery::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssAtRootSelector::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_AT_ROOT_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_AT_ROOT_AT_RULE, children)
            }
            SCSS_AT_ROOT_QUERY => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<5usize> = RawNodeSlots::default();
            ...
            SCSS_AT_ROOT_SELECTOR => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_AT_ROOT_SELECTOR.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_AT_ROOT_SELECTOR, children)
            }
            ...
            SCSS_CONTENT_AT_RULE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_CONTENT_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_CONTENT_AT_RULE, children)
            }
            SCSS_DEBUG_AT_RULE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<3usize> = RawNodeSlots::default();
            ...
            SCSS_ELSE_CLAUSE => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyScssElseClauseBody::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_ELSE_CLAUSE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_ELSE_CLAUSE, children)
            }
            SCSS_ERROR_AT_RULE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<3usize> = RawNodeSlots::default();
            ...
            SCSS_EXTEND_AT_RULE => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssExtendOptionalModifier::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_EXTEND_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_EXTEND_AT_RULE, children)
            }
            SCSS_EXTEND_OPTIONAL_MODIFIER => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_EXTEND_OPTIONAL_MODIFIER.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_EXTEND_OPTIONAL_MODIFIER, children)
            }
            SCSS_FOR_AT_RULE => {
                let mut elements = (&children).into_iter();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && matches!(element.kind(), T![to] | T![through])
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_FOR_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_FOR_AT_RULE, children)
            }
            SCSS_FORWARD_AS_CLAUSE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_FORWARD_AS_CLAUSE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_FORWARD_AS_CLAUSE, children)
            }
            SCSS_FORWARD_AT_RULE => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssForwardAsClause::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyScssForwardVisibilityClause::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssWithClause::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_FORWARD_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_FORWARD_AT_RULE, children)
            }
            SCSS_FUNCTION_AT_RULE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_FUNCTION_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_FUNCTION_AT_RULE, children)
            }
            SCSS_HIDE_CLAUSE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<2usize> = RawNodeSlots::default();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssModuleMemberList::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_HIDE_CLAUSE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_HIDE_CLAUSE, children)
            }
            SCSS_IF_AT_RULE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<4usize> = RawNodeSlots::default();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssElseClause::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_IF_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_IF_AT_RULE, children)
            }
            SCSS_IMPORT_AT_RULE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<3usize> = RawNodeSlots::default();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssImportItemList::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_IMPORT_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_IMPORT_AT_RULE, children)
            }
            SCSS_INCLUDE_ARGUMENT_LIST => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_INCLUDE_ARGUMENT_LIST.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_INCLUDE_ARGUMENT_LIST, children)
            }
            SCSS_INCLUDE_AT_RULE => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyScssIncludeTarget::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
            ...
            SCSS_INTERPOLATED_DASHED_IDENTIFIER => {
                ...
                let mut current_element = elements.next();
                if let Some(element) = &current_element
                    && ScssInterpolatedIdentifierPartList::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_INTERPOLATED_DASHED_IDENTIFIER.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_INTERPOLATED_DASHED_IDENTIFIER, children)
            }
            SCSS_INTERPOLATED_IDENTIFIER => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_INTERPOLATED_IDENTIFIER.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_INTERPOLATED_IDENTIFIER, children)
            }
            SCSS_INTERPOLATED_IDENTIFIER_HYPHEN => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_INTERPOLATED_IDENTIFIER_HYPHEN.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
            ...
            SCSS_INTERPOLATED_STRING => {
                ...
                let mut current_element = elements.next();
                if let Some(element) = &current_element
                    && element.kind() == SCSS_STRING_QUOTE
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssInterpolatedStringPartList::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_INTERPOLATED_STRING.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
            ...
            SCSS_KEYFRAMES_SELECTOR => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_KEYFRAMES_SELECTOR.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
            ...
            SCSS_MIXIN_AT_RULE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_MIXIN_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_MIXIN_AT_RULE, children)
            }
            SCSS_MODULE_CONFIGURATION => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_MODULE_CONFIGURATION.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_MODULE_CONFIGURATION, children)
            }
            SCSS_MODULE_CONFIGURATION_LIST => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssModuleConfigurationItemList::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_MODULE_CONFIGURATION_LIST.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_MODULE_CONFIGURATION_LIST, children)
            }
            SCSS_MODULE_MEMBER_ACCESS => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_MODULE_MEMBER_ACCESS.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_MODULE_MEMBER_ACCESS, children)
            }
            SCSS_NAMESPACED_VARIABLE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_NAMESPACED_VARIABLE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_NAMESPACED_VARIABLE, children)
            }
            ...
            SCSS_PARAMETER => {
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssParameterDefaultValue::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_PARAMETER.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_PARAMETER, children)
            }
            SCSS_PARAMETER_DEFAULT_VALUE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_PARAMETER_DEFAULT_VALUE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_PARAMETER_DEFAULT_VALUE, children)
            }
            SCSS_PARAMETER_LIST => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<3usize> = RawNodeSlots::default();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssParameterItemList::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
            ...
            SCSS_PLACEHOLDER_SELECTOR => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_PLACEHOLDER_SELECTOR.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_PLACEHOLDER_SELECTOR, children)
            }
            SCSS_PLAIN_IMPORT => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<4usize> = RawNodeSlots::default();
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_PLAIN_IMPORT.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_PLAIN_IMPORT, children)
            }
            SCSS_RETURN_AT_RULE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<3usize> = RawNodeSlots::default();
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_RETURN_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_RETURN_AT_RULE, children)
            }
            SCSS_SHOW_CLAUSE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<2usize> = RawNodeSlots::default();
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_SHOW_CLAUSE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_SHOW_CLAUSE, children)
            }
            SCSS_STRING_TEXT => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<1usize> = RawNodeSlots::default();
                let mut current_element = elements.next();
                if let Some(element) = &current_element
                    && element.kind() == SCSS_STRING_CONTENT_LITERAL
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
            ...
            SCSS_SUPPORTS_INTERPOLATED_CONDITION => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_SUPPORTS_INTERPOLATED_CONDITION.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_SUPPORTS_INTERPOLATED_CONDITION, children)
            }
            ...
            SCSS_USE_ALL_NAMESPACE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_USE_ALL_NAMESPACE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_USE_ALL_NAMESPACE, children)
            }
            SCSS_USE_AS_CLAUSE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<2usize> = RawNodeSlots::default();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && AnyScssUseNamespace::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_USE_AS_CLAUSE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_USE_AS_CLAUSE, children)
            }
            SCSS_USE_AT_RULE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<5usize> = RawNodeSlots::default();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssUseAsClause::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_USE_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_USE_AT_RULE, children)
            }
            SCSS_VARIABLE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<2usize> = RawNodeSlots::default();
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_VARIABLE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_VARIABLE, children)
            }
            SCSS_VARIABLE_DECLARATION => {
                ...
                let mut current_element = elements.next();
                if let Some(element) = &current_element
                    && AnyScssVariableDeclarationName::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_VARIABLE_DECLARATION.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_VARIABLE_DECLARATION, children)
            }
            ...
            SCSS_WHILE_AT_RULE => {
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_WHILE_AT_RULE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_WHILE_AT_RULE, children)
            }
            SCSS_WITH_CLAUSE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<2usize> = RawNodeSlots::default();
                ...
                slots.next_slot();
                if let Some(element) = &current_element
                    && ScssModuleConfigurationList::can_cast(element.kind())
                {
                    slots.mark_present();
                    current_element = elements.next();
                }
                ...
                if current_element.is_some() {
                    return RawSyntaxNode::new(
                        SCSS_WITH_CLAUSE.to_bogus(),
                        children.into_iter().map(Some),
                    );
                }
                slots.into_node(SCSS_WITH_CLAUSE, children)
            }
            TW_APPLY_AT_RULE => {
                let mut elements = (&children).into_iter();
                let mut slots: RawNodeSlots<3usize> = RawNodeSlots::default();
            ...
            SCSS_IMPORT_ITEM_LIST => Self::make_separated_list_syntax(
                kind,
                children,
                AnyScssImportItem::can_cast,
                T ! [,],
                false,
            ),
            SCSS_INTERPOLATED_IDENTIFIER_PART_LIST => Self::make_node_list_syntax(
                kind,
                children,
            ...
            SCSS_MODULE_CONFIGURATION_ITEM_LIST => Self::make_separated_list_syntax(
                kind,
                children,
                AnyScssModuleConfiguration::can_cast,
                T ! [,],
                true,
            ),
            SCSS_MODULE_MEMBER_LIST => Self::make_separated_list_syntax(
                kind,
                children,
                AnyScssModuleMember::can_cast,
                T ! [,],
                true,
            ),
            SCSS_PARAMETER_ITEM_LIST => Self::make_separated_list_syntax(
                kind,
                children,
